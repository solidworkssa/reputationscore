# 19-reputationscore - Base Native Architecture
...
Reputationscore provides a decentralized solution for peer review and rating system on both Base (EVM) and Stacks blockchains.
